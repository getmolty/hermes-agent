...
PROVIDER_REGISTRY: Dict[str, ProviderConfig] = {
    ...
    "inception": ProviderConfig(
        id="inception",
        name="Inception Labs",
        auth_type="api_key",
        inference_base_url="https://api.inceptionlabs.ai/v1",
        api_key_env_vars=("INCEPTION_API_KEY",),
...
def resolve_provider(
    ...
    *,
    ...
    _PROVIDER_ALIASES = {
        ...
        "inception-labs": "inception", "inceptionlabs": "inception", "mercury": "inception",
