...
def _build_apikey_providers_list() -> list:
    ...
    _static = [
        ...
        ("Venice AI",        ("VENICE_API_KEY",),                            "https://api.venice.ai/api/v1/models", "VENICE_BASE_URL", True),
        ("Inception Labs",   ("INCEPTION_API_KEY",),                         "https://api.inceptionlabs.ai/v1/models", "INCEPTION_BASE_URL", True),
    ...
    _name_to_canonical = {
        ...
        "Arcee AI": "arcee", "GMI Cloud": "gmi", "Venice AI": "venice",
        "Inception Labs": "inception", "DeepSeek": "deepseek",
