...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    "minimax-m3": 1000000,
    "minimax": 204800,
    # GLM — GLM-5.2 is the coding-plan frontier route. Z.AI's devpack docs
    # expose it as ``glm-5.2`` (the Claude Code-only ``glm-5.2[1m]`` alias is
    # not accepted by the OpenAI-compatible API) with a 1M context window.
    "glm-5.2": 1000000,
    "glm": 202752,
